...
async function createSite() {
  ...
  try {
    ...
    const domainInput = await question(`Enter domain (or press Enter for "${suggestedDomain}"): `);
    ...
    const siteNameInput = await question(`Enter site name (or press Enter for "${suggestedName}"): `);
