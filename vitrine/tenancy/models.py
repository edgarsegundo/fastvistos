...
class ClientModel(models.Model):
    ...
    - Leitura: `objects` já filtra automaticamente pelo client corrente
      (thread-local setado pelo CurrentClientMiddleware). Use `all_objects`
      quando precisar explicitamente enxergar todos os tenants (ex: painel
      interno, management command).
