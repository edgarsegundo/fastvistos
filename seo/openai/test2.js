...
async function reescreverArtigo(caminhoArquivoEntrada, caminhoSaida) {
  ...
  // Lê múltiplos arquivos de entrada
  const textoArtigo1 = fs.readFileSync("artigo1_original.txt", "utf8");
  const textoArtigo2 = fs.readFileSync("artigo2_original.txt", "utf8");
