...
describe('BlogService', () => {
            ...
            const mockTopics = [
                {
                    ...
                    order: 1,
                    is_removed: false,
                    description: 'Dicas sobre vistos americanos',
                },
                {
                    id: 2,
                    name: 'eTA Canadá',
                ...
                },
                {
                    ...
                    order: 3,
                    is_removed: false,
                    description: 'Guias para vistos mexicanos',
                },
            ];
    ...
    describe('getRecentArticles', () => {
        ...
        it('should use default limit of 5 when no limit specified', async () => {
            mockPrisma.blogArticle.findMany = (options) => {
                console.log(
                    '🔍 getRecentArticles Default Limit Query:',
                    JSON.stringify({ take: options.take }, null, 2)
                );
        ...
        it('should return topics with their associated articles', async () => {
            ...
            result.forEach((topic, topicIndex) => {
                ...
                topic.blog_article.forEach((article, articleIndex) => {
                    ...
                    console.log(`            Slug: ${article.slug}`);
                    console.log(
                        `            Published: ${article.published.toISOString().split('T')[0]}`
                    );
                    console.log(`            Excerpt: ${article.excerpt}`);
                });
            });
