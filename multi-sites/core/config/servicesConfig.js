...
export const servicesData = [
    {
        ...
        description: 'Se você precisa renovar seu visto americano, ou se está solicitando pela primeira vez, podemos te ajudar.',
        bullets: [
        ...
        schema: {
            ...
            description: 'Acompanhamento completo para solicitação de vistos de turismo, estudo, trabalho e negócios para os EUA.',
            offers: {
                '@type': 'Offer',
                price: 'Sob consulta',
                priceCurrency: 'BRL',
    ...
    },
    {
        ...
        subtitle: 'eTA CANADÁ 🇨🇦',
        description: 'Facilitamos o processo de obtenção da autorização eletrônica de viagem para o Canadá.',
        bullets: [
            'Processo 100% online',
        ...
        schema: {
            ...
            description: 'Acompanhamento completo para obtenção da autorização eletrônica de viagem (eTA) para o Canadá.',
            offers: {
                '@type': 'Offer',
                price: 'Sob consulta',
                priceCurrency: 'BRL',
    ...
    },
    {
        ...
        description: 'Auxiliamos na solicitação do visto mexicano para turismo, negócios ou estudos.',
        bullets: [
        ...
        schema: {
            ...
            description: 'Acompanhamento completo para solicitação de visto mexicano para turismo, negócios ou estudos.',
            offers: {
                '@type': 'Offer',
                price: 'Sob consulta',
                priceCurrency: 'BRL',
