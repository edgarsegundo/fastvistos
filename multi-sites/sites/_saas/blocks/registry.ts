...
export type FieldType =
    ...
    | 'css'
    | 'htmlAttrs'
    // Formatação inline estilo Carrd (negrito/itálico/cor/etc num TRECHO do
    // texto, não no elemento inteiro — ver blocks/inline-markup.ts). Edição
    // por painel (textarea + toolbar), não mais contentEditable no canvas.
    | 'richText';
...
export const BLOCK_SCHEMAS: Record<string, BlockSchema> = {
    ...
    Hero: {
        ...
        fields: {
            ...
            eyebrow: { type: 'richText', label: 'Texto do eyebrow', showFor: ['centered', 'split', 'fullbleed', 'avatars', 'pricing'], hideWhen: { field: 'showEyebrow', equals: 'no' } },
            // Aparência por elemento (estilo Carrd) interlear logo após cada campo
            // de conteúdo, com o MESMO hideWhen — some/aparece junto com ele.
            // Chave de cada `objectFields` = mesmo nome do `data-el` no render
    ...
    Sobre: {
        ...
        fields: {
            ...
            headingStyle: elementStyleField({ elementKey: 'heading', elementLabel: 'Título', kind: 'text' }),
            text: { type: 'textarea', label: 'Texto (parágrafos)', inlineEditable: false },
            textStyle: elementStyleField({ elementKey: 'text', elementLabel: 'Texto', kind: 'text' }),
            imageUrl: { type: 'image', label: 'Imagem' },
            imageStyle: elementStyleField({ elementKey: 'image', elementLabel: 'Imagem', kind: 'media' }),
    ...
    Cta: {
        ...
        fields: {
            title: { type: 'text', label: 'Título' },
            titleStyle: elementStyleField({ elementKey: 'title', elementLabel: 'Título', kind: 'text' }),
            subtitle: { type: 'textarea', label: 'Subtítulo' },
            subtitleStyle: elementStyleField({ elementKey: 'subtitle', elementLabel: 'Subtítulo', kind: 'text' }),
            ctaText: { type: 'text', label: 'Texto do botão' },
            ctaHref: { type: 'url', label: 'Link do botão' },
            ctaStyle: elementStyleField({ elementKey: 'cta', elementLabel: 'Botão', kind: 'button' }),
        },
    },
    Contato: {
        label: 'Contato',
        ...
        fields: {
            ...
            phoneStyle: elementStyleField({ elementKey: 'phone', elementLabel: 'Telefone', kind: 'text' }),
            whatsapp: { type: 'text', label: 'WhatsApp (com DDI/DDD)', inlineEditable: false },
            whatsappStyle: elementStyleField({ elementKey: 'whatsapp', elementLabel: 'WhatsApp', kind: 'text' }),
            email: { type: 'text', label: 'E-mail' },
            emailStyle: elementStyleField({ elementKey: 'email', elementLabel: 'E-mail', kind: 'text' }),
            address: { type: 'textarea', label: 'Endereço' },
            addressStyle: elementStyleField({ elementKey: 'address', elementLabel: 'Endereço', kind: 'text' }),
            hours: { type: 'text', label: 'Horário' },
            hoursStyle: elementStyleField({ elementKey: 'hours', elementLabel: 'Horário', kind: 'text' }),
            mapEmbedUrl: { type: 'url', label: 'URL de mapa (embed)' },
            mapStyle: elementStyleField({ elementKey: 'map', elementLabel: 'Mapa', kind: 'media' }),
        },
    },
};
