...
const testType = args.includes('--unit') ? 'unit' : 
                 ...
                 args.includes('--real') ? 'real' : 'real'; // Default to real database tests
...
if (testType === 'unit') {
  ...
  try {
    ...
    if (error.message.includes('Cannot find module')) {
      console.error('❌ Could not import BlogService or integration test. Make sure the database is configured.');
    } else {
